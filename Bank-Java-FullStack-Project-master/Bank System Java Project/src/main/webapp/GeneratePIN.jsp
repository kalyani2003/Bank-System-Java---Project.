...
<html lang="en" data-bs-theme="auto">
  <head>
    ...
    <title>GeneratePIN</title>
    <link rel="stylesheet" href="GeneratePIN.css">
  ...
  <body class="bodyTag">
    ...
    <main class="form-signin w-100 m-auto">
      <form action="PINGenerate"method="POST">
        <div class="BankName">
          <h1 class="A">A</h1>
          <h1 class="S">S</h1>
        ...
        <%if(password!=null){ %>
        <p class="pSuccess"><%=password %></p>
        <%} %>
        <%String error=(String)request.getAttribute("error"); %>
        <%if(error!=null){ %>
        <p class="pFailed"><%=error %></p>
        <%} %>
        ...
        <button class="btn btn-primary Login">GeneratePIN</button>
      </form>
    </main>
  </body>
</html>